...
public class GetOrderListTests {
    ...
    @Test
    @DisplayName("Получить заказы от уникального пользователя, вошедшего в систему")
    @Description("Успешно получены заказы от уникального пользователя, вошедшего в систему")
    ...
    @Test
    @DisplayName("Получить заказы от уникального незарегистрированного пользователя")
    @Description("Не удалось получить заказы от уникального незарегистрированного пользователя")
